...
REFRESH_TOKEN_EXPIRY_SECONDS = get_int("REFRESH_TOKEN_EXPIRY_SECONDS", 7 * 24 * 60 * 60)
WEBSOCKET_TOKEN_EXPIRY_SECONDS = get_int("WEBSOCKET_TOKEN_EXPIRY_SECONDS", 5 * 60)
